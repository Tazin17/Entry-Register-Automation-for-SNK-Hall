...
const ProfileCard = ({ name,Designation, Department, lateEntries, temporaryLeaves }) => {
  return (
    <div className="bg-[rgb(241,229,216)] rounded-lg shadow-lg p-6 h-full text-center w-[110%] ml-[2px]">
      {/* Profile Avatar */}
      ...
      <div className="ml-[340px] w-24 h-24 rounded-full overflow-hidden">
            ...
            >
              <img
                src="https://c0.wallpaperflare.com/preview/692/379/612/saint-martin.jpg"
                alt="cover"
